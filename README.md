...
According to [the draught permit application](https://www.southernwater.co.uk/media/7278/11-description_of_the_proposal-1.pdf) by Southern Water(section 2.3.3), Testwood Bridge GS does not exist, which is why the 
final HOF of River Test is measured by summing the readings of the following gauge stations: 
